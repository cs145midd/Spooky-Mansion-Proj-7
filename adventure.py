...
theatre = create_room("Movie Theatre", "This is the movie theatre of the mansion.")
##
# Let's connect them together.
# It's not a very fun adventure, but it's simple.
##
create_exit(hallway, theatre, "A door leads into a mysterious room.")
create_exit(theatre, hallway, "A door leads into the hall.")
...
create_exit(theatre, hallway, "Nevermind; go back to the hallway.")
create_exit(hallway, theatre, "Nevermind; go back to the hallway.")
